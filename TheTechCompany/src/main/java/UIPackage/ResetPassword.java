...
public class ResetPassword extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtNewPassword, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtOldUsername, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtConfirmNewPassword, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(115, 115, 115))
        );
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
       String Username=txtOldUsername.getText();
       String Password=txtNewPassword.getText();
       String ConfirmPassword=txtConfirmNewPassword.getText();
       if(txtOldUsername.getText().isEmpty() || txtNewPassword.getText().isEmpty() || txtConfirmNewPassword.getText().isEmpty()){
       
          JOptionPane.showMessageDialog(null, "Fields cannot be empty,When adding a new User.", "Reset Password", JOptionPane.WARNING_MESSAGE);
            
       
       }else if (!txtNewPassword.getText().equals(txtConfirmNewPassword.getText())) {
            JOptionPane.showMessageDialog(null, "Password and confirm password should match", "Reset Password", JOptionPane.ERROR_MESSAGE);
       ...
       try {
        ...
        // Execute SQL update statement to set the new password for the given username
        ...
        this.dispose();
            ...
            JOptionPane.showMessageDialog(null, "Failed to update password. Username not found.", "Reset Password", JOptionPane.ERROR_MESSAGE);
        }
           stmt.close();
        con.close();
